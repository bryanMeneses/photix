...
class Latest extends Component {
  ...
  componentDidMount() {
    ...
    fetch(
      `https://photix-server.netlify.app/.netlify/functions/index/unsplash/photos?per_page=${perPage}&page=${page}`
    )
      .then((res) => res.json())
      .then((data) => {
        if (data.errors) {
        ...
        {!images[0] ? null : (
          ...
          >
            <div
              ...
              style={{ width: "80%", margin: "0px auto", paddingTop: "200px" }}
            >
              ...
              <p>
                ...
                <span
                  className="text-link"
                  onClick={() =>
                    (window.location.href = `/search?query=black and white`)
                  }
                >
                  "black and white"
                </span>
                ...
                <span
                  className="text-link"
                  onClick={() =>
                    (window.location.href = `/search?query=nature`)
                  }
                >
                  "nature"
                </span>
                ...
                <span
                  className="text-link"
                  onClick={() =>
                    (window.location.href = `/search?query=flower`)
                  }
                >
                  "flower"
                </span>
